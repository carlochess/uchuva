(function(angular) {
    ...
    angular.module('FileManagerApp').service('fileNavigator', [
        ...
        FileNavigator.prototype.list = function() {
            ...
            return this.apiMiddleware.list(this.currentPath, cwd ,this.deferredHandler.bind(this));
        };
        ...
        FileNavigator.prototype.upDir = function() {
            if (this.currentPath[0]) {
				...
				this.c = this.currentPath[this.currentPath.length-1];
                this.refresh();
            }
        };
